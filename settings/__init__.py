...
settings_list = [
    ...
    ['Debrid Services', [
        ...
        setting('TorBox API Key', 
                'Please enter your TorBox API Key: ',
                debrid.services.torbox, 
                'api_key',
                hidden=True,
                help='Enter your TorBox API key. You can find this in your TorBox settings page under the API key section.'),
        setting('TorBox Base URL', 
                'Please enter your TorBox server address (default: https://api.torbox.app): ', 
                debrid.services.torbox,
                'api_base',
                hidden=True),
        setting('TorBox API Version', 
                'Please enter the TorBox API version (default: v1): ',
                debrid.services.torbox,
                'api_version',
                hidden=True),
    ]
